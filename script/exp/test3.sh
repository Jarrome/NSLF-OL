report=outdir/surface_plus_HG1SH_replica_report.txt
echo "metrics" > ${report}
for model in surface_plus_HG1SH
do
	for rep_scene in  office4 #office0 office1 office2 office3 office4 room0 room1 room2
	do
		python surface_train.py configs/replica/${model}/replica_${rep_scene}.yaml
